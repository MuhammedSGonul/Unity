...
public class g_kayanKopru : MonoBehaviour
{
    //köprüleri negatif x ekseninde başlat

    float t, sonPozX, baslangicPozisyonuX;
    public float kopruKaymaHizi = 0.01f;
    ...
    void Update()
    {
        ...
        {
            this.gameObject.transform.position = new Vector3(this.gameObject.transform.position.x + kopruKaymaHizi * Time.deltaTime * 100, this.gameObject.transform.position.y, this.gameObject.transform.position.z);
